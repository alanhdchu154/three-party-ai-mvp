...
- `traj_ev_005` dimension_score · high · synthetic-only · Dimension `future_planning` is Level 1. · `data/dimension_scores/michael_mom.json`
...
- `traj_ev_005` dimension_score · high · synthetic-only · Dimension `family_dynamics` is Level 2. · `data/dimension_scores/michael_mom.json`
