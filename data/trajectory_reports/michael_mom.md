...
- `traj_ev_006` dimension_score · high · synthetic-only · Dimension `social_development` is Level 1. · `data/dimension_scores/michael_mom.json`
...
- `traj_ev_003` dimension_score · high · synthetic-only · Dimension `family_dynamics` is Level 2. · `data/dimension_scores/michael_mom.json`
...
- `traj_ev_003` dimension_score · high · synthetic-only · Dimension `identity` is Level 2. · `data/dimension_scores/michael_mom.json`
