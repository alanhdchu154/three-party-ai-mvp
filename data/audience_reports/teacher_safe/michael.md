...
- `social_development` Level 1
- `identity` Level 2
- `financial_pressure` Level 1
...
- Treat visible behavior as a signal to support, not as the full explanation.

## What You Can Offer
- adjust classroom communication
- observe changes over time
- help coordinate realistic academic next steps
