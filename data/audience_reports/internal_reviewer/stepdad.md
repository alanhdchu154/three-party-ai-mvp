...
- identity Level 2: 8 supporting signal(s) recorded in dimension score; high-specificity details withheld.
...
- `ev_002` dimension_score · high · synthetic-only · family_dynamics Level 2 · `data/dimension_scores/stepdad.json`
- `ev_003` dimension_score · high · synthetic-only · identity Level 2 · `data/dimension_scores/stepdad.json`
- `ev_004` dimension_score · high · synthetic-only · future_planning Level 1 · `data/dimension_scores/stepdad.json`
- `ev_005` dimension_score · high · synthetic-only · risk dimensions · `data/dimension_scores/stepdad.json`
...
- `ev_007` coordinator_report · high · synthetic-only · privacy constraints · `existing artifact`
