...
- family_dynamics Level 2: 23 supporting signal(s) recorded in dimension score; high-specificity details withheld.
- social_development Level 1: 13 supporting signal(s) recorded in dimension score; high-specificity details withheld.
- identity Level 2: 22 supporting signal(s) recorded in dimension score; high-specificity details withheld.
- financial_pressure Level 1: 5 supporting signal(s) recorded in dimension score; high-specificity details withheld.
- future_planning Level 1: 8 supporting signal(s) recorded in dimension score; high-specificity details withheld.

## What we know
- `ev_001` dimension_score · high · synthetic-only · emotional_safety Level 1 · `data/dimension_scores/michael_mom.json`
- `ev_002` dimension_score · high · synthetic-only · family_dynamics Level 2 · `data/dimension_scores/michael_mom.json`
- `ev_003` dimension_score · high · synthetic-only · social_development Level 1 · `data/dimension_scores/michael_mom.json`
- `ev_004` dimension_score · high · synthetic-only · identity Level 2 · `data/dimension_scores/michael_mom.json`
- `ev_005` dimension_score · high · synthetic-only · financial_pressure Level 1 · `data/dimension_scores/michael_mom.json`
- `ev_006` dimension_score · high · synthetic-only · future_planning Level 1 · `data/dimension_scores/michael_mom.json`
- `ev_007` dimension_score · high · synthetic-only · risk dimensions · `data/dimension_scores/michael_mom.json`
...
- `ev_009` coordinator_report · high · synthetic-only · privacy constraints · `existing artifact`
