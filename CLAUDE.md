...
This file is for Claude Code / cc or another bounded worker picking up work on this project. Read this first.
...
- Read `/Users/alanhdchu/umi-central/goals.md` before local planning. The central `three-party-ai-mvp` row is the v0.1 / weekly / daily routing layer; this repo's `WORKLOG.md` plus fresh audit output are local evidence, and `umi/workload.md` is one scoped worker handoff.
